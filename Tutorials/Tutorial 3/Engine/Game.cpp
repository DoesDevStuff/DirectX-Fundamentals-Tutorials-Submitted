...
//	context->RSSetState(m_states->Wireframe());
	...
	iArray[1] = 1;
	iArray[2] = 2;
	vArray[0] = VertexPositionColor(Vector3(0.f, 0.5f, 0.5f),	Colors::Red);	
	vArray[1] = VertexPositionColor(Vector3(-0.5f, -0.5f, 0.5f),Colors::Red);
	vArray[2] = VertexPositionColor(Vector3(0.5f, -0.5f, 0.5f), Colors::Red);
