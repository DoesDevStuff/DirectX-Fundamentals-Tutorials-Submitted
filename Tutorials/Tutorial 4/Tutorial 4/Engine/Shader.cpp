...
bool Shader::SetShaderParameters(ID3D11DeviceContext * context, DirectX::SimpleMath::Matrix * world, DirectX::SimpleMath::Matrix * view, DirectX::SimpleMath::Matrix * projection)
{
	...
	lightPtr->ambient = DirectX::SimpleMath::Vector4(0.55f, 0.55f, 0.55f, 1.0f);
	lightPtr->diffuse	= DirectX::SimpleMath::Vector4(1.7f, 1.5f, 1.0f, 1.0f);			
	lightPtr->direction = DirectX::SimpleMath::Vector3(-1.0f, -1.0f, 0.0f);			
