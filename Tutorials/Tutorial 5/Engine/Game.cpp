...
//	context->RSSetState(m_states->Wireframe());
	...
	m_BasicShaderPair.SetShaderParameters(context, &m_world, &m_view, &m_projection, &m_Light, m_texture2.Get(), m_texture3.Get());
	...
	//setup and draw cube
	m_BasicShaderPair.EnableShader(context);
	m_BasicShaderPair.SetShaderParameters(context, &m_world, &m_view, &m_projection, &m_Light, m_texture3.Get(), m_texture1.Get());
...
void Game::CreateDeviceDependentResources()
{
	...
	//load Textures
	CreateDDSTextureFromFile(device, L"Tiny_skin.dds", nullptr, m_texture1.ReleaseAndGetAddressOf());
    CreateDDSTextureFromFile(device, L"fire.dds", nullptr, m_texture2.ReleaseAndGetAddressOf());
    CreateDDSTextureFromFile(device, L"moss.dds", nullptr, m_texture3.ReleaseAndGetAddressOf());
}
